...
<!--                            	<div class="col-xs-6 col-sm-4"><a href="#" class="text-green"><span class="h2"><i class="fa fa-envelope-o"></i></span><p class="text-gray no-margn">Messages</p></a></div>
                                ...
                                <div class="col-xs-6 col-sm-4"><a href="<?php echo $this->Html->url(array('controller' => 'email_contents','action' => 'index')); ?>" class="text-yellow"><span class="h2"><i class="fa fa-folder-open-o"></i></span><p class="text-gray">Email Templates</p></a></div>
                                
                                <div class="col-xs-12 visible-xs-block"><hr></div>
                                
                                <div class="col-xs-6 col-sm-4"><a href="<?php echo $this->Html->url(array('controller' => 'newsletters','action' => 'index')); ?>" class="text-primary"><span class="h2"><i class="fa fa-flag-o"></i></span><p class="text-gray">NewsLetters List</p></a></div>
                                <div class="col-xs-6 col-sm-4"><a href="<?php echo $this->Html->url(array('controller' => 'rooms','action' => 'faverote')); ?>" class="text-info"><span class="h2"><i class="fa fa-star-o"></i></span><p class="text-gray">Favorites Listings</p></a></div>
                            </div>
                        </div>
                    </div>
                </li>
