<div class="warper container-fluid">
	<div class="panel panel-default">
		<div class="panel-heading">
			FAQ'S List
			<a class='btn btn-success btn-sm pull-right' href='<?php echo $this->Html->url(array('controller' => 'faqs', 'action' => 'add','admin' => true)); ?>'>Add FAQ</a>
		</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#dataTables-users').DataTable({
            ...
            //"filter":false,        
            "ajax": '<?php echo $this->Html->url(array("controller" => "faqs", "action" => "faqGrid", "admin" => TRUE)); ?>',
            "columns": [
                {"name": "Faq.id", "orderable": false, "searchable": false, 'width': '5%', 'sClass': 'text-center'},
                {"name": "Faq.question", 'width': '40%'},
                {"name": "Faq.answer", 'width': '40%'},
                {"name": "Faq.common", "orderable": false, "searchable": false, 'width': '15%', 'sClass': 'text-center'},
            ],
            "order": [
